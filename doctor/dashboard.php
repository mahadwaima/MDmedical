				...
				<div class="widget stats-widget">
					<div class="widget-body clearfix">
						...
						<div class="pull-left">
							<?php 
						 $docid=$_SESSION['damsid'];;
$sql ="SELECT * from  tblappointment where Status='Deleted' && Doctor=:docid ";
$query = $dbh -> prepare($sql);
$query-> bindParam(':docid', $docid, PDO::PARAM_STR);
$query->execute();
$results=$query->fetchAll(PDO::FETCH_OBJ);
...
?>
							<h3 class="widget-title text-danger"><span class="counter" data-plugin="counterUp"><?php echo htmlentities($totapt);?></span></h3>
							<small class="text-color">Deleted Appointment</small>
						</div>
						<span class="pull-right big-icon watermark"><i class="fa fa-file-text-o"></i></span>
					</div>
					<footer class="widget-footer bg-danger">
						<a href="deleted-appointment.php"><small> View Detail</small></a>
