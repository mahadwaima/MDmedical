...
if(isset($_SESSION['damsid']) || isset($_SESSION['pharmid'])){
  ...
  $sql="update tbldoctor set FullName=:name,MobileNumber=:mobilenumber,Email=:email,Specialization=:sid , house=:house where ID=:did";
     $query = $dbh->prepare($sql);
     $query->bindParam(':name',$name,PDO::PARAM_STR);
     $query->bindParam(':email',$email,PDO::PARAM_STR);
     $query->bindParam(':mobilenumber',$mobno,PDO::PARAM_STR);
     $query->bindParam(':house',$activate,PDO::PARAM_STR);
...
{               ?>
        <option value="<?php  echo htmlentities($row1->ID);?>"><?php  echo htmlentities($row1->Specialization);?></option><?php $cnt=$cnt+1;}} ?> 
              ...
              <div class="form-group">
                <label for="email2" class="col-sm-3 control-label">Activate the go home option:</label>
                <div class="col-sm-9">
