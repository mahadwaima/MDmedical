...
if(isset($_POST['login'])) 
  {
    ...
    $sql ="SELECT ID,Email , Specialization FROM tbldoctor WHERE Email=:email and Password=:password";
...
if($result->Specialization == 14) {
	$_SESSION['pharmid'] = $result->ID ; 
	$_SESSION['pharmemailid']=$result->Email;
