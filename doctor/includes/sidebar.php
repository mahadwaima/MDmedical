  ...
  <div class="app-user">
    <div class="media">
      ...
      <div class="media-body">
        <div class="foldable">
          <?php
$eid=isset($_SESSION['damsid']) ?  $_SESSION['damsid'] : $_SESSION['pharmid'];
      ...
      <ul class="app-menu">
          ...
          if(isset($_SESSION['pharmid'])) { ?>
              <li class="has-submenu">
                ...
                <i class="menu-icon zmdi zmdi-hospital-alt zmdi-hc-lg"></i>
                  <span class="menu-text">Pharmacy</span>
                  <i class="menu-caret zmdi zmdi-hc-sm zmdi-chevron-right"></i>
                </a>
                <ul class="submenu">
                  <li><a href="pharmacy.php"><span class="menu-text">Pharmacy Manage</span></a></li>
                  <li><a href="Add_Medicine.php"><span class="menu-text">Add a medicine</span></a></li>
       ...
       <li class="has-submenu">
          ...
          <ul class="submenu">
            ...
            <li><a href="order.php"><span class="menu-text">Go to Home</span></a></li>
